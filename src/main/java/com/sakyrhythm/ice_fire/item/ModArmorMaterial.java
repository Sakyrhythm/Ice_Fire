...
public class ModArmorMaterial {
    public static final RegistryEntry<ArmorMaterial> ICE_DIAMOND = register("ice_diamond" +
    ...
    private static RegistryEntry<ArmorMaterial> register(
        ...
        List<ArmorMaterial.Layer> list = List.of(new ArmorMaterial.Layer(Identifier.of(Ice_Fire.MOD_ID)));
