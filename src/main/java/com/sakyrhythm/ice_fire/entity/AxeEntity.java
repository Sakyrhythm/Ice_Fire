...
public class AxeEntity extends PersistentProjectileEntity {
    private static final TrackedData<Byte> LOYALTY = DataTracker.registerData(AxeEntity.class, TrackedDataHandlerRegistry.BYTE);
    private static final TrackedData<Boolean> ENCHANTED = DataTracker.registerData(AxeEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    private boolean dealtDamage;
    public int returnTimer;

    public AxeEntity(World world, LivingEntity owner, ItemStack stack) {
        super(EntityType.TRIDENT, owner, world, stack, null); // 使用自定义的斧头实体类型
        this.dataTracker.set(LOYALTY, this.getLoyalty(stack));
        this.dataTracker.set(ENCHANTED, stack.hasGlint());
    }

    public AxeEntity(World world, double x, double y, double z, ItemStack stack) {
        super(EntityType.TRIDENT, x, y, z, world, stack, stack);
        this.dataTracker.set(LOYALTY, this.getLoyalty(stack));
        this.dataTracker.set(ENCHANTED, stack.hasGlint());
    }

    public AxeEntity(EntityType<AxeEntity> entityType, World world) {
    ...
    public ItemStack getWeaponStack() {
        return this.getItemStack(); // 确保 getItemStack() 返回斧头物品的 ItemStack
    }
    ...
    protected ItemStack getDefaultItemStack() {
        return new ItemStack(ModItems.ACTIVATED_FIRE_CRYSTAL_SHARD_AXE); // 使用自定义斧头物品
    }
