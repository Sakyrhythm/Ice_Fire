...
public class ModEntitiesRender  extends EntityRenderer<TridentEntity> {
    public static final Identifier TEXTURE = Identifier.of("textures/item/activated_fire_crystal_shard_axe.png");
    private final TridentEntityModel model;

    public ModEntitiesRender(EntityRendererFactory.Context context) {
        super(context);
